...
<html>
	...
	<body>
		...
		<div class="container">		
			<div class="containerWide" id="container">
			    <div class="content">
	                <div class="naviWrap">
	                    <div class="navi"> 
							...
							<c:if test="${!empty user.selectedCurrMenu.upMenuMngt}">
								...
								&gt; <a href="<c:url value="${user.selectedCurrMenu.upMenuMngt.upMenuMngt.menuUrl}"/>"><s:message code="${user.selectedCurrMenu.upMenuMngt.upMenuMngt.mlangCdNm}" text="${user.selectedCurrMenu.upMenuMngt.upMenuMngt.menuNm}" /></a>
								</c:if>
							&gt; <a href="<c:url value="${user.selectedCurrMenu.upMenuMngt.menuUrl}"/>"><s:message code="${user.selectedCurrMenu.upMenuMngt.mlangCdNm}" text="${user.selectedCurrMenu.upMenuMngt.menuNm}" /></a>
							</c:if> 
